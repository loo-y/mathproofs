		...
		<div className="relative overflow-hidden pt-24 md:pt-32">
			...
			<div className="container max-w-6xl px-4 sm:px-6 relative z-10">
				<div className="flex flex-col items-center text-center max-w-4xl mx-auto">
					...
					>
						Upload any mathematical problem as an image or type it in. Our AI will analyze, formalize and generate a step-by-step solution
						with formal proof verification.
					</motion.p>
